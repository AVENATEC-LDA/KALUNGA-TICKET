            ...
            <Group gap="md" mb="md" align="flex-start">
                ...
                <div style={{flex: 1}}>
                    ...
                    <Text size="xs" c="dimmed" fs="italic">
                        {t`Thanks for your support as we continue to grow and improve KALUNGA TICKET!`}
                    </Text>
                </div>
            </Group>
        </Card>
    ...
    return (
        <div className={paymentClasses.stripeInfo}>
            ...
            <Text size="sm" c="dimmed" mb="lg">
                {getConfig("VITE_APP_NAME", "KALUNGA TICKET")} charges platform fees to maintain and improve our services.
